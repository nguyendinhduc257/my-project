<template>
  ...
  <div
    ...
    <div>
      ...
      <div v-if="!isAlreadyInWishlist && props.showRemoveFromWishlist"
    ...
    <div v-if="!props.disableDeleteButton" @click="handleRemoveFromWishList"
...
const discountedPrice = computed(() => {
  ...
  return Number(props?.price - (props?.price * props?.discount) / 100).toFixed(3)
})
